  ...
  return (
    <footer id="contact" className="bg-slate-700 py-10">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-6 mb-10">
          ...
          <a href="tel:+918306612328" className="w-full md:w-1/3">
            <div className="flex items-center gap-4 bg-white rounded-xl p-4 shadow-md transition hover:scale-105">
              <img src="/phone.png" alt="Phone" className="w-10 h-10 sm:w-12 sm:h-12" />
              <div>
                <h5 className="text-base sm:text-lg font-semibold text-gray-800">
                  Any query call us
                </h5>
                <p className="text-sm sm:text-base text-gray-700">+91 8306612328</p>
              </div>
            </div>
          </a>
          ...
          <a href="mailto:revision24@yahoo.com" className="w-full md:w-1/3">
            <div className="flex items-center gap-4 bg-white rounded-xl p-4 shadow-md transition hover:scale-105">
              <img src="/email.png" alt="Email" className="w-10 h-10 sm:w-12 sm:h-12" />
              <div>
                <h5 className="text-base sm:text-lg font-semibold text-gray-800">
                  Any suggestion mail us
                </h5>
          ...
          <div className="w-full md:w-1/3">
            <div className="bg-blue-600 rounded-xl p-4 flex justify-around items-center h-full">
              <a href="https://www.facebook.com/revision24official/" target="_blank" rel="noopener noreferrer">
                <FaFacebookSquare className="text-white text-2xl sm:text-3xl" />
              </a>
              ...
              <a href="https://t.me/revision24official" target="_blank" rel="noopener noreferrer">
                <FaTelegram className="text-white text-2xl sm:text-3xl" />
              </a>
            </div>
          </div>
        </div>
        ...
        {/* Footer Bottom */}
        <div className="flex flex-col md:flex-row justify-between items-center gap-3 text-white text-xs sm:text-sm">
