...
//     const planData = {
//       amount: item.offer_price, // only send base price!
...
//                   })}
//                 </div>
//                 {/* GST Information - Mobile (Display Only) */}
//                 {selectedPlan && (() => {
//                   const gstInfo = calculateGST(selectedPlan.offer_price);
//                   return (
//                     <div className="border-t mt-4 sm:mt-6 pt-4 sm:pt-6 bg-gray-50 rounded-lg p-4">
//                       <h4 className="font-semibold text-gray-800 mb-3">Price Information</h4>
//                       <div className="space-y-2">
//                         <div className="flex justify-between text-sm">
//                           <span>Plan Price:</span>
//                           <span>₹{gstInfo.basePrice}</span>
//                         </div>
//                         <div className="flex justify-between text-sm text-gray-600">
//                           <span>GST (18%):</span>
//                           <span>₹{gstInfo.gstAmount}</span>
//                         </div>
//                         <div className="border-t pt-2 flex justify-between text-sm text-gray-600">
//                           <span>Total (incl. GST):</span>
//                           <span>₹{gstInfo.totalWithGST}</span>
//                         </div>
...
//                       {selectedPlan
//                         ? `₹${calculateGST(selectedPlan.offer_price).totalWithGST}`
//                         : "₹0"}
//                     </span>
//                   </div>
//                   <button
...
//                         (sub) =>
//                           sub.subscription_name === selectedPlan.subscription_name
//                       )
//                       ? "Renew Subscription"
//                       : "Proceed To Payment"}
//                   </button>
...
//                               )}
//                             </div>
//                             <p className="text-sm xl:text-base text-gray-500">{plan.duration} months</p>
//                             {isActivePlan && (
...
//                     })}
//                   </div>
//                   {/* GST Information - Desktop (Display Only) */}
//                   {selectedPlan && (() => {
//                     const gstInfo = calculateGST(selectedPlan.offer_price);
//                     return (
//                       <div className="bg-gray-50 rounded-lg p-4 xl:p-5 mb-6">
//                         <h4 className="font-semibold text-gray-800 mb-3">Price Information</h4>
...
//                             <span>₹{gstInfo.totalWithGST}</span>
//                           </div>
//                           <div className="border-t pt-3 flex justify-between font-semibold text-lg text-green-600">
//                             <span>You Pay:</span>
//                             <span>₹{gstInfo.totalWithGST}</span>
//                           </div>
//                         </div>
