                ...
                <div className="flex-1 p-4 overflow-y-auto">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {selectedGroup.questions.map((q, qIndex) => {
                            ...
                            if (isSelected) bg = 'bg-green-600';        // attempted
                            if (isMarkedAns) bg = 'bg-yellow-300 border-2 border-green-500'; // marked & selected
                            else if (isMarked) bg = 'bg-red-400';    // only marked
                            else if (isSkipped) bg = 'bg-red-600';      // skipped
                    ...
                    <div className="mt-6 text-white w-full max-w-md">
                        <div className="grid grid-cols-2 gap-y-3 text-sm">
                            ...
                            <div className="text-right">({selectedGroup.questions.length - optionSelected.length})</div> */}
