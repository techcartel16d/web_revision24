                      ...
                      <>
                        ...
                        <div className="space-y-3 sm:space-y-4">
                          {groupedTests[date]
                            ...
                            .map((testData) => (
                              <div key={`${testData.test_id}-${testData.attended_at}`} className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6">
                                <div className="flex flex-col gap-4">
                                  ...
                                  <div className="flex flex-col sm:flex-row gap-2">
                                    ...
                                    <button 
                                      className="px-3 sm:px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 flex items-center justify-center transition-colors text-sm"
                                      onClick={() => handleReattemptClick(testData)}
                                    >
                                      Reattempt
                                      <svg className="w-4 h-4 ml-1" fill="currentColor" viewBox="0 0 20 20">
