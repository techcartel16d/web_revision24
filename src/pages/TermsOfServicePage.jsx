...
const TermsOfServicePage = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 text-gray-800 bg-white shadow-md rounded-lg">
      ...
      <p className="mb-4">
        ...
        <Link href="https://revision24.com" className="text-blue-600 hover:underline" target="_blank" rel="noreferrer"> https://revision24.com</Link> 
      ...
      <ul className="space-y-4">
        ...
        <li>
          ...
          <p>Support is available via the app or by emailing <a href="mailto:support@revision24.com" className="text-blue-600 hover:underline">support@revision24.com</a>.</p>
        </li>
