...
const Screen5 = () => {
    ...
    const isSectionalTest =
        state?.packageDetail?.data?.package_detail?.exam_category?.title === 'SSC' &&
    ...
    const handleSubmit = async () => {
        ...
        // ✅ Updated: Include subject information in each attended question
        const allAttendedQuestions = optionSelected2.map((questionId) => {
            ...
            // ✅ Include subject info with each question
            return {
                question_id: questionId,
                user_selected_ans: selectedAns,
                right_ans: rightAns,
                subject_id: question?.subject_id || null,        // ✅ Add subject_id
                subject_name: question?.subject_name || null     // ✅ Add subject_name (optional)
            };
        });
        ...
        // ✅ One submission data for entire test with subject mapping
        const submissionData = {
            test_id: testId,
            total_attend_question: totalAttendedQuestions,
            total_not_answer_question: totalNotAnsweredQuestions,
            ...
            time: totalTimeSpent,
            negative_mark: negativeMark,
            all_attend_question: allAttendedQuestions,        // ✅ Now includes subject info
            spent_time: spentTime,
        ...
        console.log('📊 Sample attended question:', allAttendedQuestions[0]);
